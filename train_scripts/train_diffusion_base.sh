...
LR_ANNEAL_STEPS=150000  # total training steps, the best checkpoint is around 130k, 110k or 70k steps for fact, head or tail generation
...
BATCH_SIZE=4
CHECKPOINT_PATH="ckpts/${DSET}/${BENCHMARK}_${TGT}_diffusion_base"
...
DROPOUT=0.1
NUM_HEADS=12
CONFIG_NAME_MODEL="facebook/bart-base"
CONFIG_NAME_EMBEDDER="ckpts/embedding/${EMB_PT_SOURCE}_emb_pt_base/model150000"
GAMMA_NLL=1.0  # gamma for weighting MSE and anchor losses used for diffusion training
NOISE_AMPLIFY=1  # factor for amplifying the standard deviation of diffusion noise
